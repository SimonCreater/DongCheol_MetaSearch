...
```
/scholar-megasearch depth=4 ferrimagnet의 spin–orbit torque switching
/scholar-megasearch L5 알터마그넷 후보 물질              # L5 = 소스 전체의 PDF 확보
/scholar-megasearch 빠르게 스커미온 레이스트랙 메모리
/scholar-megasearch 전수조사 위상 절연체 표면 상태 측정    # 전수조사 → L5
/scholar-megasearch MoE 라우팅 최근 1년 논문             # 레벨 미지정 → L2 기본
```
